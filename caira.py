...
def build_master_prompt(item):
    ...
    return (
        ...
        '20,000 style number dominates), or cutout viral card (cut-out key person centered over dark blurred '
        'background, 1-2 circle inset images of the product, ALL-CAPS condensed headline with the 2-3 key words '
        'in the accent color - best for drama/leaks/CEO stories). Then write ONE detailed vertical 4:5 prompt: '

...
def build_master_prompt(item):
    ...
    return (
        ...
        'bold caps (small chip like AI / STARTUPS above ALL-CAPS headline), or big-number poster (a huge $28M / '
        '20,000 style number dominates). Then write ONE detailed vertical 4:5 prompt: realistic photo scene of '
        'the actual subject, natural light, real textures, like a designer composed it in Photoshop - NO sci-fi '
        'glow or AI-poster look; EXACT headline rendered word for word in clean editorial type, ONE accent '
        'color, no logos/watermarks/extra text)\n'

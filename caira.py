...
def build_master_prompt(item):
    ...
    return (
        ...
        '[[IMAGE_PROMPT]]\n(a vertical 4:5 image-generation prompt that looks like a real designer made it in '
        'Photoshop/Figma, NOT an AI poster: realistic photo-based scene relevant to the story (startup office, '
        'AI lab, data centre, developer desk, newsroom), natural lighting, real textures, no sci-fi glow; top '
        '70% photo, bottom 30% clean dark band with the EXACT headline in modern editorial type, one key word '
        'highlighted in subtle blue/white; spell it exactly; no logos/watermarks/extra text)\n'

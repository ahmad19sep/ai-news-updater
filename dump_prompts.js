...
const SECTIONS = [
  ...
  ["Agent & AI research brief", "buildAgentBriefPrompt",
    win.buildAgentBriefPrompt({ title: STORY.title, source: STORY.source,
      sourceType: "<<SOURCE TYPE HINT>>", tags: ["Models", "Agent Loops"],
      published: "<<SOURCE PUBLICATION DATE>>",
      facts: "<<SOURCE FACTS / ARCHITECTURE NOTES YOU PASTED>>" })],

...
1. **Patient AI Use and the Decline of Physician Trust, With Robert Shpiner, MD - Patient Care Online** — science angle
...
2. **Akido is expanding AI for patient intake and diagnoses across 100 clinics - Endpoints News** — science angle
...
3. **When minutes matter, AI is helping diagnose stroke patients - Spectrum News** — science angle
...
4. **AI is now very good at diagnosing health problems, but doctors are still better at weighing treatment options - themercury.com** — science angle
...
5. **Medday: Ai helping doctors improve medical tests - WKMG** — science angle
...
7. **Assuta, Microsoft develop AI medical assistant to reduce relieve doctors' documentation tasks - The Jerusalem Post** — science angle

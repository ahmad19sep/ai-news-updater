...
'[[IMAGE1]]',
'(A ready-to-paste AI IMAGE-GENERATION PROMPT for a 16:9 NEWS-POSTER / YouTube-thumbnail style image WITH THE HEADLINE WRITTEN ON IT. The prompt MUST: (1) describe a photorealistic, cinematic, editorial background scene relevant to the story — real people/place/atmosphere, dramatic lighting, depth, ultra-detailed; (2) instruct that the EXACT text of the headline above appears ON the image as bold, large, modern typography — clean high-contrast sans-serif, perfectly spelled, with a subtle dark gradient scrim behind the words for readability — placed in the lower-left third and NOT covering faces; (3) spell the headline EXACTLY, word for word, in quotes; (4) no watermarks, no logos, and NO other or gibberish text — only the headline words. Premium news-thumbnail look: vibrant yet credible.)',
'[[IMAGE2]]',

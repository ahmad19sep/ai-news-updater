...
'[[IMAGE1]]',
'(A ready-to-paste AI IMAGE-GENERATION PROMPT for a VERTICAL 4:5 (1080x1350) social news poster WITH THE HEADLINE WRITTEN ON IT, in EXACTLY this style: a photorealistic, cinematic subject relevant to the story (real person / product / scene), professional dramatic lighting, sharp focus, on a dark moody background that fades darker toward the bottom to leave room for text. In the LOWER portion render the EXACT headline above as BOLD, heavy, condensed sans-serif typography (Title Case, left-aligned, 2-4 lines, tight line spacing). Set the 1-3 MOST important phrases or numbers (proper nouns, money, the punchy hook) inside SOLID BRIGHT-YELLOW highlight rectangles with BLACK text (marker-highlight look); every other word in pure WHITE. Spell the headline EXACTLY, word for word — ONLY the headline words appear, perfectly legible. NO logos, NO watermarks, NO social icons, NO other or gibberish text.)',
'[[IMAGE2]]',

...
window.buildXReplyPrompt = function (o) {
  ...
  return [
    ...
    "",
    "Pick the single BEST reply from all 7.",
    "",
    ...
    '  "best_reply": "the single strongest reply from the 7 options",',
    '  "replies": [',
    ...
    "The best_reply must be the most natural, useful, human reply for this specific post.",
  ].join("\n");
};

...
"9. AHMAD PERSONAL BRAND CARD — uses AHMAD'S OWN PHOTO (it is attached/uploaded in this chat — use it EXACTLY, do not change or regenerate his face, only cut him out cleanly): Ahmad cut out chest-up on one side over a flat modern background or softly blurred workspace; his name 'AHMAD' bold + '@aixahmad' small under it; the headline/announcement/tip text on the other side in clean editorial type with key words in the accent color; optionally a small circle inset of the product/tool he's talking about. Feels like a creator's branded news/opinion card. Best for: Ahmad's own announcements, opinions, 'my take' posts, tips from Ahmad, milestones. When you choose this format, START the prompt with: 'Use the attached photo of Ahmad exactly as provided — do not alter his face.'",
